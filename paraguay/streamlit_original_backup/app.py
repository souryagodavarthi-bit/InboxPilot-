...
# Main Dashboard View (Logged In)
    ...
    with tab4:
        ...
        custom_name = st.text_input("Category Name (e.g. Wholesale Inquiry)", placeholder="Wholesale Inquiry", disabled=(total_enabled >= MAX_CATEGORIES))
        custom_desc = st.text_area("Category Description (Explain to the AI when to route emails here)", placeholder="Customer is asking about bulk orders, pricing list, or wholesale partnership terms.", disabled=(total_enabled >= MAX_CATEGORIES))
        ...
        if st.button("Add Category", key="add_custom_category_btn", disabled=(total_enabled >= MAX_CATEGORIES)):
